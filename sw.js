...
//
// v3.13.10 更新：浮动区间打分卡片（如"中文测验按表现打分"）去掉了下方的数字
// 输入框——之前小数点输入在部分手机键盘上会被吞掉（如输入 2.5 变成 52），
// 现在只保留上方的滑块来选分值，滑块本身支持 0.1 步长，精确又不会误触。
var CACHE_NAME = 'u-points-cache-v3.13.10';
