...
//
// v3.13.45 更新：月历「本月小结」里，加分最多/减分最多改成分开统计——总分最高的
// 一项和触发次数最多的一项不一定是同一项（比如某项单次分值大但只发生过一次，
// 另一项单次分值小但天天发生），现在按分和按次数各自挑第一名，分别显示。
var CACHE_NAME = 'u-points-cache-v3.13.45';
