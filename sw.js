...
//
// v3.13.12 更新：家长端"限时优惠"表单里，开始日期/结束日期两个输入框会在
// 部分手机上撑破自身格子、往右溢出屏幕（iOS 日期选择器有比较宽的最小宽度，
// 撑爆了两栏布局）。现在给这两个格子和输入框都加上了"允许缩小到 0"的设置，
// 两个日期框可以正常并排显示，不再溢出。
var CACHE_NAME = 'u-points-cache-v3.13.12';
