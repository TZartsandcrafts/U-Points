...
//
// v3.13.24 更新：三餐记录里点某个食物后，"输入数量"从原来贴在食物列表最下面
// 的表单，改成点哪个食物就在原地弹出一个居中浮窗（跟浮动区间打分用的是同一
// 套浮窗样式），不用再点完食物往下滚半天找输入框；点浮窗外的半透明背景可以
// 直接关掉。
var CACHE_NAME = 'u-points-cache-v3.13.24';
