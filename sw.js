...
//
// v3.13.25 更新：早/午/晚/加餐的选择从三餐页面顶部的标签行，挪进了"输入数
// 量"那个弹窗里——原来的标签行每次重新打开 App 都会回到"早餐"默认值，孩子
// 容易忘记切换；现在挑food的时候顺手就能在弹窗里选，登记完直接对上顿数，
// 页面顶部的标签行去掉了。
var CACHE_NAME = 'u-points-cache-v3.13.25';
